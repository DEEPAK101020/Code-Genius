...
const XthRoadMap = () => {
  ...
  const findRoadmap = async (e) => {
    ...
    if (
      ...
      Final test difficulty level will be Medium
  ...
  return (
    <div className="container mx-auto p-5">
      <form onSubmit={findRoadmap} className="flex flex-wrap justify-around">
        {/* Form Inputs */}
      ...
      <button
        className="bg-red-500 text-white px-5 py-3 text-3xl rounded mt-5"
        onClick={findRoadmap}
      >
        Submit
      </button>
