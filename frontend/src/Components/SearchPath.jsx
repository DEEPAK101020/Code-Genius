  ...
  const handleSearch = async (e, search) => {
    ...
    try {
      ...
      switch (search) {
        case "PCMB":
          query =
            "Get detailed information about PCMB courses and career path after that";
          break;
        case "PCMC":
          query =
            "Get detailed information about PCMC courses and career path after that";
          break;
        case "PCME":
          query =
            "Get detailed information about PCME courses and career path after that";
          break;
        case "Arts":
          query =
            "Get detailed information about Arts courses and career path after that";
          break;
        case "Commerce":
          query =
            "Get detailed information about Commerce courses and career path after that";
          break;
        default:
      ...
      <Flex direction="column" align="center" minH="100vh">
        <Box w="100%" h="340px" marginTop="30px" className="searchcolor">
          <Container maxW="container.lg" p={5} textAlign="center">
            <Text as="h1" fontSize="3xl" fontWeight="bold" color="black" mb={5}>
              Enter Your Desired Course to Find The RoadMap
            </Text>
            <Text color="white" fontSize="2xl">
              Choosing a career is one of the most important decisions a person
              has to make in their life. It is so important because that is what
              we will have to do to support ourselves throughout life. Imagine
              being stuck in a dead end job and having to go to work every
              morning and dreading it.
            </Text>
          </Container>
        </Box>
        <Container maxW="container.lg" p={5} mt={-20}>
          ...
          >
            <Input
              ...
              fontWeight={"bold"}
            />
            <Button type="submit" backgroundColor="#6A69AB" mb={10}>
              Search
            </Button>
          </form>
          {error && (
          ...
          <Flex flexWrap="wrap" justify="space-between">
            ...
            >
              ...
              <Box p={5}>
                ...
                <Text color="gray.600">
                  Physics, Chemistry, Maths, Electronics.
                </Text>
              </Box>
            </Box>
            <Box
            ...
            >
              ...
              <Box p={5}>
                ...
                <Text color="gray.600">
                  Psychology, Economics, Philosophy, History, Sociology,
                  Political Science.
                </Text>
              </Box>
            </Box>
